  ...
  return (
    <div className="inline-block align-middle">
      <label htmlFor="toggle" id="theme-toggle-button" className="relative inline-block w-[7em] cursor-pointer">
        ...
        />
        <svg viewBox="0 0 69.667 44" xmlns="http://www.w3.org/2000/svg" className="w-full">
          <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
            <g filter="url(#container)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
              <rect fill="#83cbd8" transform="translate(3.5 3.5)" rx="17.5" height={35} width="60.667" data-name="container" id="container" className="transition-all duration-300" />
            </g>
            <g transform="translate(2.333 2.333)" id="button" className="transition-all duration-300">
              <g data-name="sun" id="sun" className="transition-all duration-300">
              ...
              <g data-name="moon" id="moon" className="transition-all duration-300">
            ...
            <g filter="url(#cloud)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)" className="transition-all duration-300">
            ...
            <g fill="#def8ff" transform="translate(3.585 1.325)" id="stars" className="transition-all duration-300">
